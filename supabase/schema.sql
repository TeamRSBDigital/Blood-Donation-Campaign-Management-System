-- ==============================================================================
-- Blood Donation Campaign Management System - Complete Consolidated Supabase Schema
...
INSERT INTO divisions (id, name_en, name_bn, code) VALUES ('d0000000-0000-0000-0000-000000000001', 'Dhaka', 'ঢাকা', 'DHAKA') ON CONFLICT (code) DO NOTHING;
INSERT INTO districts (id, division_id, name_en, name_bn, lat, lng) VALUES ('dt000000-0000-0000-0000-000000000001', 'd0000000-0000-0000-0000-000000000001', 'Rajbari', 'রাজবাড়ী', 23.757000, 89.650000) ON CONFLICT DO NOTHING;
INSERT INTO upazilas (id, district_id, name_en, name_bn) VALUES ('u0000000-0000-0000-0000-000000000001', 'dt000000-0000-0000-0000-000000000001', 'Pangsha', 'পাংশা') ON CONFLICT DO NOTHING;
...
INSERT INTO settings (id, org_name_bn, org_name_en, motto_bn, motto_en, primary_phone, emergency_number, email, address_bn, address_en)
VALUES (1, 'পাংশা ব্লাড ডোনার্স এসোসিয়েশন', 'Pangsha Blood Donors Association', 'রক্ত দিন, জীবন বাঁচান - মানব সেবায় আমরা সদা প্রস্তুত', 'Donate Blood, Save Lives - Ready to Serve Humanity', '+8801712000000', '+8801812999888', 'info@pbdabangladesh.org', 'পাংশা মডেল থানা রোড, পাংশা পৌরসভা, রাজবাড়ী', 'Pangsha Model Thana Road, Pangsha Pourashava, Rajbari')
ON CONFLICT (id) DO NOTHING;
