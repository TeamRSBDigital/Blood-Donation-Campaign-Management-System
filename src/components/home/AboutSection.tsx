      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="bg-white rounded-3xl p-6 border border-gray-200 shadow-md relative overflow-hidden">
              <div className="w-full h-64 sm:h-72 rounded-2xl bg-gray-100 relative overflow-hidden flex items-center justify-center">
                <img
              ...
              <div className="mt-4 pt-4 border-t border-gray-100 flex items-center justify-between text-xs text-gray-600">
                ...
                <span className="font-bold text-red-600">স্থাপিত ২০২০</span>
              </div>
            </div>
          </div>
