...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact-section" className="py-12 sm:py-16 bg-gray-50 transition-colors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-5 bg-white p-8 rounded-3xl border border-gray-200 shadow-sm space-y-6 flex flex-col justify-between">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-900">প্রধান কার্যালয়</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-900">জরুরী হেল্পলাইন</h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="text-sm font-bold text-gray-900">সেবার সময়সূচী</h3>
          ...
          <div className="lg:col-span-7 bg-gray-100 rounded-3xl p-2 border border-gray-200 shadow-sm min-h-[320px] flex flex-col relative overflow-hidden">
            <iframe
              ...
              className="w-full h-full min-h-[340px] rounded-2xl border-0 filter opacity-90 hover:opacity-100 transition-opacity"
              loading="lazy"
              allowFullScreen
            />
          </div>
