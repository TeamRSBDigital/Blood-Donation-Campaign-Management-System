    ...
    >
      ...
      <div>
        ...
        <div className="space-y-2 py-3 border-y border-slate-100 dark:border-slate-700/60 text-xs">
          <div className="flex items-start text-slate-600 dark:text-slate-300 gap-1.5 font-medium">
            <MapPin className="w-3.5 h-3.5 text-red-500 shrink-0 mt-0.5" />
            <div className="space-y-0.5">
              <p className="font-semibold text-slate-800 dark:text-slate-200">
                {donor.union}, {donor.upazila}, {donor.district}
              </p>
              {donor.village && (
                <p className="text-[11px] text-slate-500 dark:text-slate-400">গ্রাম: {donor.village}</p>
              )}
            </div>
          </div>
      ...
      <div className="mt-4 pt-2 flex items-center gap-1.5">
        <a
          ...
          className="flex-1 inline-flex items-center justify-center gap-1 bg-red-600 hover:bg-red-700 text-white font-bold py-2 px-2.5 rounded-xl text-xs shadow-xs transition-colors"
        >
        ...
        <a
          ...
          className="inline-flex items-center justify-center gap-1 py-2 px-2.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/50 text-emerald-700 dark:text-emerald-300 font-bold text-xs border border-emerald-200 dark:border-emerald-800 hover:bg-emerald-100 transition-colors"
        >
        ...
        <button
          ...
          className="inline-flex items-center justify-center gap-1 py-2 px-2.5 rounded-xl bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 text-slate-700 dark:text-slate-200 font-bold text-xs transition-colors"
        >
